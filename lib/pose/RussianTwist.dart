...
void detectRussianTwist(Map<PoseLandmarkType, PoseLandmark> landmarks) {
  ...
  // Calculate the torso rotation angle (shoulder-hip alignment)
  double shoulderTwistAngle = calculateAngle(leftShoulder, rightShoulder, rightHip);

  // Define thresholds for twist detection
  bool twistLeft = shoulderTwistAngle > 30;  // Adjust based on testing
  bool twistRight = shoulderTwistAngle < -30;
