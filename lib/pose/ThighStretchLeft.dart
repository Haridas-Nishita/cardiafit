...
void detectWarriorPose(Map<PoseLandmarkType, PoseLandmark> landmarks) {
  ...
  if ([leftHip, leftKnee, leftAnkle, rightHip, rightKnee, rightAnkle].contains(null)) {
    return;
  }

  // Calculate angles for left leg as front and right leg as back
  double frontKneeAngle = calculateAngle(leftHip!, leftKnee!, leftAnkle!);
  double backLegAngle = calculateAngle(rightHip!, rightKnee!, rightAnkle!);

  // Adjusted thresholds for low mobility
